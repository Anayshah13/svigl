  ...
  return (
    <div className="flex flex-1 items-center justify-center px-6 py-16">
      ...
      >
        ...
        <h1 className="mt-6 text-2xl font-bold tracking-tight text-ink">Welcome to Svigl</h1>
        <p className="mt-2 text-sm leading-relaxed text-ink-muted">
          Sign in with Google to enter the drawing gallery and play with friends.
        </p>
