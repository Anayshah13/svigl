 ...
 * Timer, word/hint, and settings share one row so the canvas keeps vertical space.
 */
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        {showWord ? (
          ...
          <p className="truncate text-center text-xs font-semibold leading-snug text-ink">
            {statusLabel}
          </p>
        )}
      </div>
