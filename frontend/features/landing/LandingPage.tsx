...
export function LandingPage() {
  ...
  return (
    <div className="relative min-h-0">
      ...
      <section className="relative flex min-h-[calc(100dvh-3.5rem)] flex-col justify-center lg:min-h-[88dvh]">
        <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 content-center gap-6 px-4 py-8 sm:gap-6 sm:px-6 sm:py-6 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.68fr)] lg:items-center lg:gap-10 lg:py-8">
          <div className="flex min-w-0 flex-col">
            ...
            <FadeIn>
              <motion.span
                className="hidden items-center gap-1.5 rounded-full px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider sm:inline-flex sm:px-3 sm:py-1 sm:text-xs"
            ...
            <FadeIn delay={0.08}>
              <h1 className="mt-0 text-center text-[clamp(1.85rem,7vw,2.5rem)] font-bold leading-[1.08] tracking-tight text-ink sm:mt-4 sm:text-left sm:text-5xl lg:text-[3.75rem] lg:leading-[1.05] xl:text-[4.25rem]">
                <HeadlineWords />{" "}
            ...
            <FadeIn delay={0.16}>
              <motion.div
                ...
                className="mt-5 rounded-3xl sm:mt-4"
              >
              <Card
                id="join"
                className="flex flex-col gap-3 rounded-3xl p-4 sm:gap-4 sm:p-5"
                style={{
              ...
              >
                  ...
                  <form className="flex flex-col gap-1.5" onSubmit={handleJoinSubmit}>
                    ...
                    <div className="flex gap-2">
                      <Input
                        ...
                        autoComplete="off"
                        spellCheck={false}
                        className="h-11 min-w-0 flex-1 font-mono tracking-widest uppercase"
                      />
                      <Button
                        type="submit"
                ...
                <div className="flex flex-col gap-2.5 md:flex-row md:flex-wrap">
                  <Button size="md" disabled={busy} onClick={handleCreateRoom} className="h-11 w-full md:w-auto">
                ...
                <p className="hidden script-accent text-base leading-snug sm:block sm:text-lg md:text-xl">
          ...
          <div className="hidden min-w-0 w-full max-w-[min(100%,17rem)] sm:max-w-xs lg:mx-auto lg:block lg:max-h-[calc(100dvh-5.5rem)] lg:max-w-76 lg:justify-self-center xl:max-w-84">
