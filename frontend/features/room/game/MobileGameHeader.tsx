...
/**
 * Compact top row rendered above the canvas on mobile game routes.
 * Replaces the desktop app header + whiteboard action bar with a lean
 * `timer · word · settings` layout inspired by skribbl.io.
 */
export function MobileGameHeader({
  ...
  return (
    <header
      className={cn(
        "flex shrink-0 items-center gap-2 rounded-2xl border border-plum/15 bg-white/95 px-2 py-1.5 shadow-sm",
        className,
      )}
    >
